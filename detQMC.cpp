...
double detQMC::meas_DoubleOccu(const matXd& gu, const matXd& gd) {
...
double detQMC::meas_KineticEnergy(const matXd& gu, const matXd& gd) {
...
double detQMC::meas_MomentumDist(const matXd &gu, const matXd &gd, const vecXd& p) {
    const int ll = hubb.ll;
...
double detQMC::meas_localSpinCorr(const matXd &gu, const matXd &gd) {
    const int ls = hubb.ls;
...
double detQMC::meas_StructFactor(const matXd &gu, const matXd &gd, const vecXd &p) {
    const int ll = hubb.ll;
